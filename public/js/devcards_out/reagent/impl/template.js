...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__25407__auto__,writer__25408__auto__,opt__25409__auto__){
return cljs.core._write.call(null,writer__25408__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__37986 = o;
(G__37986[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__37987__delegate = function (args){
...
while (G__37988__i < G__37988__a.length) {G__37988__a[G__37988__i] = arguments[G__37988__i + 0]; ++G__37988__i;}
  args = new cljs.core.IndexedSeq(G__37988__a,0);
} 
return G__37987__delegate.call(this,args);};
...
return G__37987__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__24789__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__24789__auto__){
var and__24789__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__37995 = jsprops;
(G__37995["defaultValue"] = value);

(G__37995["onChange"] = ((function (G__37995,v,value,on_change){
return (function (p1__37992_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__37992_SHARP_);
});})(G__37995,v,value,on_change))
);

(G__37995["ref"] = ((function (G__37995,v,value,on_change){
return (function (p1__37993_SHARP_){
return (this$["cljsInputElement"] = p1__37993_SHARP_);
});})(G__37995,v,value,on_change))
);
...
var vec__38002 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38002,(0),null);
var id = cljs.core.nth.call(null,vec__38002,(1),null);
var class$ = cljs.core.nth.call(null,vec__38002,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38007 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38007 == null)){
} else {
var key_38008 = temp__4661__auto___38007;
(jsprops["key"] = key_38008);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38010 = (new reagent.impl.template.NativeWrapper());
(G__38010["name"] = c);
...
var len__25876__auto___38016 = arguments.length;
var i__25877__auto___38017 = (0);
while(true){
if((i__25877__auto___38017 < len__25876__auto___38016)){
args__25883__auto__.push((arguments[i__25877__auto___38017]));

var G__38018 = (i__25877__auto___38017 + (1));
i__25877__auto___38017 = G__38018;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25884__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38014){
var G__38015 = cljs.core.first.call(null,seq38014);
var seq38014__$1 = cljs.core.next.call(null,seq38014);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38015,seq38014__$1);
});
...
break;
default:
var G__38022 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38022;
continue;
...
var n__25716__auto___38025 = a.length;
var i_38026 = (0);
while(true){
if((i_38026 < n__25716__auto___38025)){
(a[i_38026] = reagent.impl.template.as_element.call(null,(a[i_38026])));

var G__38027 = (i_38026 + (1));
i_38026 = G__38027;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__25716__auto___38028 = a.length;
var i_38029 = (0);
while(true){
if((i_38029 < n__25716__auto___38028)){
var val_38030 = (a[i_38029]);
if((cljs.core.vector_QMARK_.call(null,val_38030)) && ((reagent.impl.template.key_from_vec.call(null,val_38030) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38029] = reagent.impl.template.as_element.call(null,val_38030));

var G__38031 = (i_38029 + (1));
i_38029 = G__38031;
continue;
} else {
}
...
var ctx = ({});
var vec__38035 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38035,(0),null);
var derefed = cljs.core.nth.call(null,vec__38035,(1),null);
...
var G__38039 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38039) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38039){
...
//# sourceMappingURL=template.js.map?rel=1490992388721